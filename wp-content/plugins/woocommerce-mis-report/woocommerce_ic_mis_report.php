            	 ...
            	 <div class="wrap iccommercepluginwrap">                 	
                    <h2><?php _e('Dashboard - WooCommerce Advance Salse Report (FREE Version)','icwoocommercemis') ?></h2> 
                                                  ...
                                                  <div class="">
                                                    <div class="ic_box_space">
													   ...
													   <div class="submit_loader">
														  <input type="submit" name="btnSearch" class="ic_button" id="btnSearch" value="Search" />                                                      
													  </div>
                     ...
                     <div class="row">                     	
                       ...
                       <!--  <style>
                        #top_product_pie_chart, #last_7_days_sales_order_amount {
						  width: 100%;
						  height: 300px;
						}
						</style>-->
                            ...
                            <div>                                
								<div class="Notes">
									<div class="offer-plugin">
										<h4>Upgrade to Premium Gold Plugin for $169</h4>
                                        <div class="clearfix"></div>
									</div>
