...
Plugin URI: https://plugins.infosofttech.com/woocommerce-advance-sales-report-premium-gold/
...
* **Almost 40+ Reports**
The Lite version is limited to showing summary data for past one month. Purchase the paid <a href="http://plugins.infosofttech.com/product/woocommerce-advance-sales-report-premium-gold-version/" target="_blank">Pro Version</a> for full access along with more features, <a href="http://plugins.infosofttech.com/woocommerce-advance-sales-report-premium-gold/" target="_blank">Click here</a> for more details.
...
== Changelog ==
= 4.0.2 - 12-May-2022 =
* Tested: Compatible with latest WooCommerce 6.4.0 and Wordpress 6.0.0 versions.

= 4.0.1 - 10-January-2022 =
* Tested: Compatible with latest WooCommerce 6.0.0 and Wordpress 5.8.3 versions.

= 4.0 - 29-December-2021 =
* Tested: Compatible with latest WooCommerce 6.0.0 and Wordpress 5.8.2 versions.
* Fix: Bug fix.
...
= Does this work with WooCommerce 6.4.0? =
Yes. MIS Report is compatible upto WooCommerce 6.4.0

= Can I export data from MIS Report? =
No. Currently you can only see these reports. You can export the recent report csv.
