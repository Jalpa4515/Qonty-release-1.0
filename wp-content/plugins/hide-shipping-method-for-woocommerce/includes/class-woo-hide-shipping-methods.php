...
if ( !class_exists( 'Woo_Hide_Shipping_Methods' ) ) {
    class Woo_Hide_Shipping_Methods
    {
        ...
        private function define_admin_hooks()
        {
            ...
            $this->loader->add_action( 'admin_init', $plugin_admin, 'whsma_register_post_type' );
        ...
        private function define_public_hooks()
        {
            ...
            // $this->loader->add_action('woocommerce_cart_calculate_fees', $plugin_public, 'whsmp_conditional_fee_add_to_cart');
            $this->loader->add_filter(
