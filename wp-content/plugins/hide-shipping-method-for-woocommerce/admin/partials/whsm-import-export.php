...
<div class="whsm-section-left">
    <div class="whsm-import-export-section">
            ...
            <tbody>
                <tr>
                    <th scope="row" class="titledesc">
                        <label for="blogname"><?php echo esc_html__( 'Export Hide Shipping Method Rule', 'woo-hide-shipping-methods' ); ?></label>
                    </th>
                    <td>
                        <div class="whsm_main_container export_settings_container">
                            ...
                            <p class="whsm_content_container">
                                ...
                                <strong><?php esc_html_e( 'Export the hide shipping method rules settings for this site as a .json file. This allows you to easily import the configuration into another site. Please make sure simple product and variation products slugs must be unique.', 'woo-hide-shipping-methods' ); ?></strong>
                            </p>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="titledesc"><label
                            for="blogname"><?php echo esc_html__( 'Import Hide Shipping Method Rule', 'woo-hide-shipping-methods' ); ?></label>
                    </th>
                    <td>
                        <div class="whsm_main_container import_settings_container">
                            ...
                            <p class="whsm_content_container">
                                ...
                                <strong><?php esc_html_e( 'Import the shipping method settings from a .json file. This file can be obtained by exporting the settings on another site using the form above.', 'woo-hide-shipping-methods' ); ?></strong>
                            </p>
                        </div>
                    </td>
                </tr>
