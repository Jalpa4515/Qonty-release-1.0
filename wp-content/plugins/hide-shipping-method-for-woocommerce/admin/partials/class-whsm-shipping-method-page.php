...
if ( !class_exists( 'WHSM_Shipping_Method_Page' ) ) {
    class WHSM_Shipping_Method_Page
    {
         ...
         * @since 3.5
         */
        public static function whsmsmp_register_post_type()
        {
         ...
         *
         */
        public function whsmsmp_sz_duplicate_method( $id )
        {
            $cust_nonce = filter_input( INPUT_GET, 'cust_nonce', FILTER_SANITIZE_STRING );
            $get_tab = filter_input( INPUT_GET, 'tab', FILTER_SANITIZE_STRING );
        ...
        private static function whsmsmp_sz_save_method( $method_id = 0 )
        {
            ...
            $action = filter_input( INPUT_GET, 'action', FILTER_SANITIZE_STRING );
            $get_tab = filter_input( INPUT_GET, 'tab', FILTER_SANITIZE_STRING );
            $whsm_save = filter_input( INPUT_POST, 'whsm_save', FILTER_SANITIZE_STRING );
        ...
        public static function whsmsmp_sz_list_methods_screen()
        {
			...
			<div class="whsm-section-left">
	            <h1 class="wp-heading-inline">
					<?php 
            echo  esc_html( __( 'Conditional Hide Shipping Method Rules', 'woo-hide-shipping-methods' ) ) ;
            ?>
	            </h1>
	            <a href="<?php 
            echo  esc_url( $link ) ;
            ...
            $WC_Shipping_Methods_Table->search_box( esc_html__( 'Search Hide Shipping Rule', 'woo-hide-shipping-methods' ), 'whsm-shipping' );
