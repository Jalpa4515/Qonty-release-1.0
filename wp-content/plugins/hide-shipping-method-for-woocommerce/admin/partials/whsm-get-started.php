...
?>
	...
	<table class="table-mastersettings table-outer form-table" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="fr-2">
				<p class="block gettingstarted textgetting"><b><?php 
esc_html_e( 'Using this plugin you can hide shipping based on below options :-', 'woo-hide-shipping-methods' );
?></b></p>
...
?>
				...
				<p class="block gettingstarted textgetting">
					<span class='desc_text'>
						<?php 
echo  sprintf( wp_kses( __( '<strong>Option 2: </strong>Hide all other shipping method and when "Free Shipping" or "Local Pickup" available on the cart page', 'woo-hide-shipping-methods' ), array(
    'strong' => array(),
) ) ) ;
?>
					</span>
