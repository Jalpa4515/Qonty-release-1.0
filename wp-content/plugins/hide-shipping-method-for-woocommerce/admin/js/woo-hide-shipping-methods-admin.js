(function ($) {
    ...
    $(document).ready(function() {
        ...
        var show_sidebar = localStorage.getItem('whsm-sidebar-display');
        ...
        $(document).on( 'click', '.toggleSidebar', function(e){
            ...
            if( $('.all-pad').hasClass('hide-sidebar') ){
                localStorage.setItem('whsm-sidebar-display', 'hide');
                span_full.removeClass('dashicons-arrow-right-alt2').addClass('dashicons-arrow-left-alt2');
                ...
                localStorage.setItem('whsm-sidebar-display', 'show');
                span_full.removeClass('dashicons-arrow-left-alt2').addClass('dashicons-arrow-right-alt2');
