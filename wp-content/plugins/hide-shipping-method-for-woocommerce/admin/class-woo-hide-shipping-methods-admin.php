...
class Woo_Hide_Shipping_Methods_Admin
{
    ...
    public function whsma_enqueue_scripts( $hook )
    {
        ...
        if ( false !== strpos( $hook, 'woocommerce_page_whsm' ) ) {
            ...
            wp_localize_script( $this->plugin_name, 'coditional_vars', array(
                ...
                'weight'                         => esc_html__( 'Weight (kg) ( In Pro )', 'woo-hide-shipping-methods' ),
     ...
     * @since    1.3.2
     */
    public function whsm_pro_fetch_slug( $id_array, $condition )
    {
        $return_array = array();
        if ( !empty($id_array) ) {
     ...
     * @since    1.3.2
     */
    public function whsm_pro_fetch_id( $slug_array, $condition )
    {
        $return_array = array();
        if ( !empty($slug_array) ) {
