...
<div style="<?php echo esc_attr(Functions::generate_inline_style($inline_style)) ?>"
    ...
    <div class="<?php echo rtwpvg()->get_option('preloader') ? 'loading-rtwpvg' : ''; ?> rtwpvg-wrapper rtwpvg-thumbnail-position-<?php echo esc_attr($thumbnail_position) ?> rtwpvg-product-type-<?php echo esc_attr($product_type) ?>">
