		...
		add_action(
			...
			function () {
				...
				if (mktime(0, 0, 0, 11, 22, 2021) <= $current && $current <= mktime(0, 0, 0, 12, 6, 2021)) {
					if (get_option('rtwpvg_bf_2021') != '1') {
						if (! isset($GLOBALS['rtwpvg_bf_2021_notice'])) {
							$GLOBALS['rtwpvg_bf_2021_notice'] = 'rtwpvg_bf_2021';
							self::notice();
						}
					}
				}
	...
	public static function notice() {
		...
		add_action(
			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-rtwpvgdismissable="rtwpvg_bf_2021"
		...
		add_action(
			...
			function () {
				...
				update_option('rtwpvg_bf_2021', '1');
				wp_die();
			}
		);
	}
